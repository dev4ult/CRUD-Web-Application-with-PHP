        ...
        <div class="flex gap-4">
            ...
            <div class="form-control">
                <div class="input-group">
                    ...
                    <button id="search-btn" class="btn btn-sm btn-square btn-success text-white">
            ...
            <a href="logout.php" class="btn btn-sm btn-warning ml-auto">Log out</a>
        </div>
        ...
        <div class="modal-box">
            ...
            <form class="flex flex-col gap-2 " action="" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-action">
                    <input type="submit" value="Tambah" class="btn btn-sm btn-success text-white" name="tambah-data">
                </div>
            </form>
